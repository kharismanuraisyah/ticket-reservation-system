...
<div id="main">
	<div class="content">
		<center><h2>Konfirmasi Reservasi</h2></center>
			...
			<h3>ID Reservasi: <?php echo $reservasi=$tampil['id_reservasi']; ?></h3> 
			<br><br>
			...
			<input type="hidden" name="id_penumpang" value="<?php echo $tampil['id_penumpang']; ?>">
				<table class="table table-striped-bordered">
					...
					<tr>
						...
						<td width="50">:</td>
						<td><?php echo $kereta=$tampil['id_kereta']; ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<center><td><button class="btn">Selanjutnya</button></td></a></center>
				</form>
