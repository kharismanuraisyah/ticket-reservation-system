	...
	<div class="content">
		...
		<form action="inserttiket.php" method="POST">
			<div class="input-group">
				ID Tiket:<input type="text" placeholder="ID Tiket" style="width: 300px;" name="id_tiket">
			</div>
			<div class="input-group">
			...
			<div class="input-group">
				...
				<select name="kursi" id="nok">
					<option value='0'>-Pilih Kursi-</option>
					<?php  for($nok=1;$nok<=12;$nok++) echo "<option value='".$nok."'>$nok</option>" ?>
				</select>
			</div>
			<div class="input-group">
